(function(){
  if(document.readyState==='loading'){
    document.write('<scr'+'ipt src="plantdex-cloud-v2.js?v=20260907-egressfix1"></scr'+'ipt><scr'+'ipt src="plantdex-pedigree.js?v=20260828-pedigree1"></scr'+'ipt>');
  }else{
    const cloud=document.createElement('script');
    cloud.src='plantdex-cloud-v2.js?v=20260907-egressfix1';
    cloud.onload=()=>{
